...
?>
	<section class="side-menu fixed left">
		<div class="top-sec">
			<div class="dash_logo">
				<img src="../images/Precision Stamping Craft.png" alt="Precision Stamping Craft Logo">
			</div>
			...
			<div class="wrapper add_employee clearfix">
				...
				<form id="editemployee" class="clearfix" method="" action="">
					...
					<div class="input-box input-small left">
						...
						<input type="text" class="inputField emp_id"  name="employee_id" value="<?php echo $employee_id ?>">
					...
					<div class="input-box input-small left">
						...
						<input type="text" class="inputField middlename"  name="middlename" value="<?php echo $middlename ?>">
					...
					<div class="input-box input-small left">
						<label for="dateemployed">Date Hired</label><br>
